...
class SkillLevelCalculator:
    ...
    # 레벨 1-10까지 정의 (현실적인 레벨링 시스템)
    # 기존 시스템 대비 2-3배 더 엄격한 기준 적용
    LEVEL_THRESHOLDS = {
        1: 0,        # Lv.1 (초보): 0-199 (기존 0-99에서 2배 증가)
        2: 200,      # Lv.2 (입문): 200-499 (기존 100-299에서 2배 증가)
        3: 500,      # Lv.3 (초급): 500-999 (기존 300-599에서 약 1.7배 증가)
        4: 1000,     # Lv.4 (중급): 1000-1999 (기존 600-999에서 약 1.7배 증가)
        5: 2000,     # Lv.5 (고급): 2000-3999 (기존 1000-1999에서 2배 증가)
        6: 4000,     # Lv.6 (전문가): 4000-6999 (기존 2000-3999에서 2배 증가)
        7: 7000,     # Lv.7 (시니어): 7000-11999 (기존 4000-6999에서 약 1.75배 증가)
        8: 12000,    # Lv.8 (리드): 12000-19999 (기존 7000-9999에서 약 1.7배 증가)
        9: 20000,    # Lv.9 (아키텍트): 20000-29999 (기존 10000-14999에서 2배 증가)
        10: 30000,   # Lv.10 (마스터): 30000+ (기존 15000+에서 2배 증가)
    }
